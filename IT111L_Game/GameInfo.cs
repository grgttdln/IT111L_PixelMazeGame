...
{
    // Internal class representing game information
    internal class GameInfo
    {
        public FontGameCollection.FontGame fontGame = new FontGameCollection.FontGame();

        // Private fields representing UI elements and game variables
        ...
        // Constructor to initialize default game values and UI elements
        public GameInfo()
        {
            level = 1;
            life = 5;
        ...
        // Properties to access UI elements
        ...
        {
            get { return isBgPlaying; }
            set { isBgPlaying = value; }
        }
