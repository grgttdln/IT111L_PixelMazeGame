...
namespace IT111L_Game
{
    internal class Timer
    {
        ...
        public void ContPauseGameTimer()
        {
        ...
        public void GameTimer_Tick(object sender, EventArgs e)
        {
            ...
            //Console.WriteLine(Program.gInfo.Pause);
            ...
            if (!Program.gInfo.Pause)
            {
                    ...
                    if (item is Label)
                    {
                        ...
                        if ((string)item.Tag == "coin")
                        {
                            if (GetPlayer.PlayerGame.Bounds.IntersectsWith(item.Bounds) && item.Visible == true)
                            {
                                ...
                                //item.Visible = false;
                                NewGame.level_1.Level1_MainPanel.Controls.Remove(item);
                            }
                        }
                        // enemy
                        if ((string)item.Name == "enemy")
                        {
                            if (GetPlayer.PlayerGame.Bounds.IntersectsWith(item.Bounds))
                            {
                                ...
                                //GetPlayer.PlayerGame.Image = Resources.right_lose;
                                GetPlayer.PlayerGame.Left -= 35;
                                //GetPlayer.PlayerGame.Image = Resources.front_lose;
                            }
                ...
                //NewGame.level_1.enemiesCollection[0].Left += NewGame.level_1.enemiesSpeedCollection[0];
                //NewGame.level_1.enemiesCollection[1].Left += NewGame.level_1.enemiesSpeedCollection[1];
            }
